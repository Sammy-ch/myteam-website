...
const Hero = () =>{
    return (
        <section className={"grid grid-cols-2 px-[165px] py-[100px] sm:pb-[150px] md:grid-cols-1 md:items-center min-h-[37.5rem] sm:min-h-[30rem] md:px-[45px] w-full hero-background "}>
                ...
                <div className={"flex flex-col gap-4 md:justify-center md:items-center"}>
                    ...
                    <p className={"body1 text-white relative top-[90px] md:top-0 md:text-center md:w-[467px] sm:w-[327px] sm:text-[15px] "}>
